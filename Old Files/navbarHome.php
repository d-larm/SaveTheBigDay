...
<nav class="navbar navbar-default" style="margin-bottom:0px;">
  <div class="container-fluid" style="background-color: #CDB8AE; border-bottom:15px solid white;">
	    	...
	    	<!-- Places the profile element if the user session is still active, else it places the sign in element which allows the user to log in -->
	      	<?php
		      	...
		      	if(isset($_SESSION["id"])){
		    		...
		    		echo "<li class=dropdown id=profileNav><a class='dropdown-toggle' data-toggle='dropdown' style='color:white;' href='#' id=profile>{$name} <span class='caret'></span></a><ul class=dropdown-menu><li><a href='profile.php'>PROFILE</a></li><li id=messageNav><a href='#'>MESSAGES</a></li><li id=logoutNav><a href='#'>LOG OUT</a></li></ul></li>";
		      	}else
		...
		if(emailValid && passwordValid){
			...
			$.post("verifyLogin.php",postData,function(data){
				...
				if(returnData["success"]){
					...
					$("#signIn").addClass("dropdown");
					$("#signIn").html("<a class='dropdown-toggle' data-toggle='dropdown' style='color:white;' href='#' id=profile>"+returnData["name"].toUpperCase()+" <span class='caret'></span></a><ul class=dropdown-menu><li><a href='profile.php'>PROFILE</a></li><li id=messageNav><a href='#'>MESSAGES</a></li><li id=logoutNav><a href='#'>LOG OUT</a></li></ul>")
