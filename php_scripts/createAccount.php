...
<body>
	...
	<div ng-app="login">
		...
		<form ng-controller="loginDetails" method=POST>
			...
			<p><input type=password ng-model="password">{{password}}</p>
			<label>First Name</label>
			<p><input type=text>{{firstname}}</p>
			<label>Last Name</label>
			<p><input type=text>{{lastname}}</p>
			<label>Address Line 1</label>
			<p><input type=text>{{address1}}</p>
			<label>City</label>
			<p><input type=text>{{city}}</p>
			<label>Country</label>
        ...
        <div id="cid_1" class="form-input jf-required">
          <select class="form-dropdown" id="input_1" name="q1_countries" style="width:155px;" data-component="dropdown">
            <option value="">  </option>
